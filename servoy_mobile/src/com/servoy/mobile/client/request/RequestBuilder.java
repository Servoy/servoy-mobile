...
public class RequestBuilder
{
	...
	/*
	 * Internal method that actually sets our cached headers on the underlying JavaScript XmlHttpRequest object. If there are no headers set, then we set the
	 * "Content-Type" to "text/plain; charset=utf-8". This is really lining us up for integration with RPC.
	 */
